...
public class NotificationHelper {
    ...
    private static final String CHANNEL_DESCRIPTION = "Notifications for incoming SMS messages";
    ...
    public static void showNotification(Context context, String sender, String message) {
        // Create an intent to open SmsCallActivity
        Intent intent = new Intent(context, SmsCallActivity.class);
